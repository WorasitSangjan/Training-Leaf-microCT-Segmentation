"""
Leaf CT Segmentation — UNet + ResNet101  [Phase 1]
===================================================
...
SLURM: torchrun --nproc_per_node=4 train_1_unet_resnet101.py
"""
...
model = smp.Unet(encoder_name="resnet101", encoder_weights="imagenet",
...
if is_main:
    print("=" * 70)
    print(f"[CONFIG] model=UNet/ResNet101 LR={LR} wd=5e-3 patch={PATCH_SIZE} stride={STRIDE} "
...
if is_main:
    ...
    model_eval = smp.Unet(encoder_name="resnet101", encoder_weights=None, in_channels=1, classes=NUM_CLASSES)
